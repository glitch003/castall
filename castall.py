...
chromecasts, browser = pychromecast.get_chromecasts(tries=1, retry_wait=1)
# browser.stop_discovery()

# Siiick party
url = 'https://s3-us-west-1.amazonaws.com/chriscassano-dev/siiick-final.mp4'
...
for cc in chromecasts:
  print("-------------------------------")
  print("-------------------------------")
  print("Getting info on {}".format(cc.name))
  cc.wait()
  print(cc)
  print(cc.status)

  if cc.cast_type == 'audio':
  ...
  print("***** Casting to {} *****".format(cc.name))
